public struct FilePermissions: OptionSet {
  ...
  // Execute Filepermissions for other
  ...
  // Write Filepermissions for group
  ...
  // Execute Filepermissions for group
